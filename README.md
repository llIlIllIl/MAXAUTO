...
일정 확률로 "=" 키 입력 발생시 프로그램이 작동하지 않는 문제<br>
갱신 성공시 애니메이션 이벤트<br>
...
프로그램 자동 인식<br>
하단 라이선스 부분 작성 개선<br>
영상 녹화 및 고스트 기능? (플레이 고스트로 만들어서 배틀)<br>

~~로컬 DB를 기준으로 기록갱신 실패시, Enter키를 입력한것으로 간주하는 버그~~ 수정됨<br>
~~서버에 저장된 DB를 로컬로 가져오는 기능~~ 구현 성공<br>
